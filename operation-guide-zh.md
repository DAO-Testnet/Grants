...
![图片](https://uploader.shimo.im/f/nimOp4hwFkwvW7bI.png!thumbnail)

注：VOTE Token公投提案是社区成员对项目的预审核，是非必要步骤（该操作指南可在【项目预审核】中查看）；

提案1、2都由开发者申请；此处省略了提案1的执行、提案2的发起；
...
（1）第一轮投票：DAO组织选择项目，对该提案投票（同意/反对/弃权）；
...
### 步骤4：发放资金
4.1 链上审核-提案投票：DAO组织在浏览器中对该提案进行审核、投票（同意/反对/弃权）；
